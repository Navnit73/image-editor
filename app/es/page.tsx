...
const homeFaqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: 'Yes, switch to the "Eliminador de Fondo Masivo" tab at the top of the page. You can drag and drop multiple images at once, and our AI will automatically remove the backgrounds in sequence.',
      },
    },
    {
      "@type": "Question",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  ...
                  <div className="max-w-xl">
                    ...
                    <h1 className="hero-fade-in hero-fade-in-delay-1 text-4xl sm:text-5xl lg:text-[3.5rem] font-black tracking-tight leading-[1.1] text-slate-900 dark:text-white mb-5">
                      ...
                      <br />
                      <span className="text-slate-700 dark:text-slate-300">Directo en tu Navegador</span>
                    </h1>

                    {/* Subheadline */}
                    <p className="hero-fade-in hero-fade-in-delay-2 text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-8 max-w-md">
                      Redimensionar, comprimir, eliminar fondos y añadir texto — all powered by on-device AI. 
                      ...
                      >
                        ...
                        <div className="relative flex flex-col items-center text-center">
                          ...
                          <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2">
                            {isDragActive ? "¡Suelta tu imagen aquí!" : "Sube Tu Foto"}
                          </h3>
        ...
        <section className="mt-16 max-w-5xl mx-auto px-4 md:px-0 space-y-20">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4 text-slate-900 dark:text-white">
              El Mejor Editor de Fotos Online Gratis — Sin Software, Sin Registro
            </h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-6 text-slate-800 dark:text-slate-100">
              How to Editar Fotos Online in 3 Steps
            </h2>
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-3 text-slate-800 dark:text-slate-100">¿Listo para Editar tus Fotos??</h2>
          ...
          <div className="pt-8 border-t border-slate-200 dark:border-slate-800 pb-12">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                ["/passport-photo-editor", "Passport Editor de Fotos"],
                ["/visa-photo-editor", "Visa Editor de Fotos"],
              ].map(([href, label]) => (
                <Link key={href} href={href} className="text-sm px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-colors">
                  {label}
                </Link>
