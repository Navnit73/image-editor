...
const homeFaqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: 'Yes, switch to the "Suppresseur de Fond en Masse" tab at the top of the page. You can drag and drop multiple images at once, and our AI will automatically remove the backgrounds in sequence.',
      },
    },
    {
      "@type": "Question",
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                  ...
                  <div className="max-w-xl">
                    ...
                    <h1 className="hero-fade-in hero-fade-in-delay-1 text-4xl sm:text-5xl lg:text-[3.5rem] font-black tracking-tight leading-[1.1] text-slate-900 dark:text-white mb-5">
                      ...
                      <br />
                      <span className="text-slate-700 dark:text-slate-300">Directement dans votre Navigateur</span>
                    </h1>

                    {/* Subheadline */}
                    <p className="hero-fade-in hero-fade-in-delay-2 text-lg text-slate-600 dark:text-slate-400 leading-relaxed mb-8 max-w-md">
                      Redimensionnez, compressez, supprimez les fonds et ajoutez du texte — all powered by on-device AI. 
                      ...
                      >
                        ...
                        <div className="relative flex flex-col items-center text-center">
                          ...
                          <h3 className="text-xl font-bold text-slate-800 dark:text-white mb-2">
                            {isDragActive ? "Déposez votre image ici !" : "Téléchargez Votre Photo"}
                          </h3>
        ...
        <section className="mt-16 max-w-5xl mx-auto px-4 md:px-0 space-y-20">
          ...
          <div>
            <h2 className="text-3xl font-bold mb-4 text-slate-900 dark:text-white">
              Le Meilleur Éditeur de Photos en Ligne Gratuit
            </h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-6 text-slate-800 dark:text-slate-100">
              How to Modifier des Photos Online in 3 Steps
            </h2>
          ...
          <div className="text-center">
            <h2 className="text-2xl font-bold mb-3 text-slate-800 dark:text-slate-100">Prêt à Modifier vos Photos ??</h2>
          ...
          <div className="pt-8 border-t border-slate-200 dark:border-slate-800">
            <h2 className="text-2xl font-bold mb-4 text-slate-800 dark:text-slate-100">
              Ressources Utiles pour Photos de Passeport et Visa
            </h2>
            <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
              Préparer une demande de passeport ou de visa nécessite une photo qui respecte les directives officielles de taille, de fond et de biométrie. Les outils en ligne peuvent vous aider à redimensionner, recadrer et valider votre image avant de la soumettre.
            </p>
            ...
            <div className="rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-sm border border-slate-200 dark:border-slate-700">
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">
                Créez des Photos de Passeport Conformes en Ligne
              </h3>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                <a
                ...
                est un éditeur de photos de passeport et de visa en ligne qui aide les utilisateurs à créer des photos biométriques pour des documents officiels. Il prend en charge les exigences de photo de passeport et de visa pour plus de 50 pays avec un recadrage automatique, un ajustement de l'arrière-plan et des vérifications de conformité.
              </p>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-slate-200 dark:border-slate-800 pb-12">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                ["/passport-photo-editor", "Passport Éditeur de Photos"],
                ["/visa-photo-editor", "Visa Éditeur de Photos"],
              ].map(([href, label]) => (
                <Link key={href} href={href} className="text-sm px-3 py-1.5 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 rounded-lg transition-colors">
                  {label}
                </Link>
