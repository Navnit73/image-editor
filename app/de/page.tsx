...
const FAQS = [
  ...
  },
  {
    ...
    a: "Ja, photoresizerai ist vollständig responsiv und auf iOS- und Android-Geräten nutzbar. Für komplexe Bearbeitungsaufgaben empfehlen wir einen Desktop-Browser, da der größere Bildschirm mehr Komfort bietet.",
  },
  {
      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pb-24 space-y-24">
        ...
        <section className="max-w-4xl">
          ...
          <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed">
            <p>
              photoresizerai ist ein leistungsstarkes, browserbasiertes
            ...
            <p>
              Das macht photoresizerai zur datenschutzfreundlichsten Wahl für
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-slate-500 dark:text-slate-400 max-w-xl mx-auto">
              ...
              nutzen photoresizerai täglich für ihre Bildbearbeitungsaufgaben.
            </p>
          </div>
        ...
        <section>
          <div className="text-center mb-10">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 dark:text-white">
              photoresizerai vs. Desktop-Software
            </h2>
            <p className="mt-3 text-slate-500 dark:text-slate-400 max-w-xl mx-auto">
        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-800 dark:from-slate-800 dark:to-slate-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
          ...
          <div className="relative max-w-3xl">
            ...
            <p className="text-slate-300 leading-relaxed mb-6">
              photoresizerai funktioniert grundlegend anders. Alle Berechnungen
        ...
        <section className="max-w-4xl">
          ...
          <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed">
            <p>
              ...
              photoresizerai ist darauf ausgelegt, Ihnen professionelle
            ...
            <p>
              ...
              Nutzern weltweit täglich photoresizerai für ihre
